...
export const comments = (state = [], action) => { //state does not refer to the entire global state object but just the part of state that the reducer is in charge of changing -> which in this case is comments
    switch (action.type){
        case SAVE_COMMENT:
